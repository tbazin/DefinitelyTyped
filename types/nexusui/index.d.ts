...
export type InterfaceColorTarget = 'accent' | 'accent' | 'fill' | 'light' | 'dark' | 'mediumLight' | 'mediumDark';
export type InterfaceColorSettings = Record<InterfaceColorTarget, string>;

export function colors(): InterfaceColorSettings;
...
declare class NexusUI {
    ...
    add: (type: any, parent: any, options: any) => any;
    Add: {};
    set context(arg: any);
    get context(): any;
...
export type NexusSequence = Sequence;
